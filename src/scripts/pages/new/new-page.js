        ...
        <div class="new-story__header">
          <div class="container">
            ...
            <p class="new-story__header__description">
              Cerita kecilmu bisa jadi inspirasi besar untuk orang lain.
            </p>
          </div>
        </div>
      </section>
            ...
            <div class="form-control">
              ...
              <div class="new-form__description__container">
                <textarea
                  ...
                  name="description"
                  placeholder="Masukkan deskripsi story mu disini ..."
                ></textarea>
              </div>
            </div>
            <div class="form-control">
              <label for="documentations-input" class="new-form__documentations__title">Photo</label>
              <div id="documentations-more-info">Kamu dapat menyertakan foto didalam storymu.</div>
            ...
            <div class="form-control">
              ...
              <div class="new-form__location__container">
                ...
                <div class="new-form__location__lat-lng">
                  <input type="number" name="latitude" value="null" disabled>
                  <input type="number" name="longitude" value="null" disabled>
                </div>
              </div>
            </div>
